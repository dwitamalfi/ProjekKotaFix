            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <nav class="navbar navbar-expand-lg" id="navi">
                        <!-- Logo -->
                        <a class="navbar-brand" href="<?php echo base_url(); ?>" ><img id="logo" src="<?php echo base_url();?>assets/img/core-img/logo2.png" alt="Logo"> <b>ADMIN PENGUMUMAN</b> PORTAL KOTA BATU</a>
                        <!-- Navbar Toggler -->
	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-12" >
				...
				<?php endif; ?>
						<form action="<?php base_url('Admin/Event/Pengumuman/add') ?>" method="post" enctype="multipart/form-data">
							<p>
								<label for="nama_pengumuman">Nama Pengumuman</label><br>
								<input class="form-control <?php echo form_error('nama_pengumuman') ? 'is-invalid' :'' ?>" name="nama_pengumuman" type="text" id="nama_pengumuman" size="70">
							...
							<p>
								...
								<textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid' :'' ?>" name="deskripsi" id="" cols="100" rows="10"></textarea>
								<div class="invalid=feedback">
