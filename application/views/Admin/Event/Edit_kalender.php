	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-12" >
				...
				<?php endif; ?>
						<form action="<?php base_url('Admin/Event/Kalender/edit') ?>" method="post" enctype="multipart/form-data">
							<input type="hidden" name="id" value="<?php echo $kalender->id_kalender?>" />
							<p>
								<label for="nama_acara">Nama Acara</label><br>
								<input class="form-control <?php echo form_error('nama_acara') ? 'is-invalid' :'' ?>" name="nama_acara" type="text" id="nama_acara" size="70" value="<?php echo $kalender->nama_acara ?>">
							...
							<p>
								...
								<input class="form-control <?php echo form_error('tanggal_acara') ? 'is-invalid' :'' ?>" name="tanggal_acara" type="text" id="datepicker" size="70" value="<?php echo $kalender->tanggal_acara ?>">
								<div class="invalid=feedback">
							...
							<p>
								...
								<input class="form-control <?php echo form_error('tempat') ? 'is-invalid' :'' ?>" name="tempat" type="text" id="tempat" size="70" value="<?php echo $kalender->tempat ?>">
								<div class="invalid=feedback">
							...
							<p> <label for="gambar">Upload Gambar</label><br>
								...
								<input type="hidden" name="old_image" value="<?php echo $kalender->gambar?>"/>
								<div class="invalid=feedback">
							...
							<p>
								...
								<textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid' :'' ?>" name="deskripsi" id="" cols="100" rows="10" ><?php echo $kalender->deskripsi ?></textarea>
								<div class="invalid=feedback">
