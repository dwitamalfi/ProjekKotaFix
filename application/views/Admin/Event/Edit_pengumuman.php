	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-12" >
				...
				<?php endif; ?>
				<form action="<?php base_url(" Admin/Event/Pengumuman/edit") ?>" method="post"
							enctype="multipart/form-data" >
						<input type="hidden" name="id" value="<?php echo $pengumuman->id_pengumuman?>" />
								<label for="nama_pengumuman">Nama pengumuman</label><br>
								<input class="form-control <?php echo form_error('nama_pengumuman') ? 'is-invalid' :'' ?>" name="nama_pengumuman" type="text" id="nama_pengumuman" size="70" value="<?php echo $pengumuman->nama_pengumuman?>">
								<div class="invalid=feedback">
									<?php echo form_error('nama_pengumuman') ;?>
								</div>
							</p>
							<p> <label for="gambar">Upload Gambar</label><br>
								<input class="form-control <?php echo form_error('gambar') ? 'is-invalid' :'' ?>" type="file" name="gambar" id="gambar" value="<?php echo $pengumuman->gambar ?>"> 
								<input type="hidden" name="old_image" value="<?php echo $pengumuman->gambar?>"/>
								<div class="invalid=feedback">
									<?php echo form_error('gambar') ;?>
								</div>
							</p>
							<p>
								<label for="deskripsi">Deskripsi pengumuman</label><br>
								<textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid' :'' ?>" name="deskripsi" id="" cols="100" rows="10" "><?php echo $pengumuman->deskripsi ?></textarea>
								<div class="invalid=feedback">
