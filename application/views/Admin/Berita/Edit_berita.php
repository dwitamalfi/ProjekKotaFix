	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-12" >
				...
				<?php endif; ?>
				<form action="<?php base_url(" Admin/Berita/Berita/edit") ?>" method="post"
							enctype="multipart/form-data" >
						<input type="hidden" name="id" value="<?php echo $berita->id_berita?>" />
								<label for="judul">Judul berita</label><br>
								<input class="form-control <?php echo form_error('judul') ? 'is-invalid' :'' ?>" name="judul" type="text" id="judul" size="70" value="<?php echo $berita->judul ?>">
								<div class="invalid=feedback">
									<?php echo form_error('judul') ;?>
								</div>
							</p>
							<p> <label for="gambar">Upload Gambar</label><br>
								<input class="form-control <?php echo form_error('gambar') ? 'is-invalid' :'' ?>" type="file" name="gambar" id="gambar" value="<?php echo $berita->gambar ?>"> 
							...
							<p>
								...
								<textarea class="form-control <?php echo form_error('isi') ? 'is-invalid' :'' ?>" name="isi" id="" cols="100" rows="10" "><?php echo $berita->isi ?></textarea>
								<div class="invalid=feedback">
