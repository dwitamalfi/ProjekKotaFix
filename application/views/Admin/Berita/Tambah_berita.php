	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-12" >
				...
				<?php endif; ?>
						<form action="<?php base_url('Admin/Berita/Berita/add') ?>" method="post" enctype="multipart/form-data">
							<p>
								<label for="judul">Judul berita</label><br>
								<input class="form-control <?php echo form_error('judul') ? 'is-invalid' :'' ?>" name="judul" type="text" id="judul" size="70">
							...
							<p>
								...
								<textarea class="form-control <?php echo form_error('isi') ? 'is-invalid' :'' ?>" name="isi" id="" cols="100" rows="10"></textarea>
								<div class="invalid=feedback">
