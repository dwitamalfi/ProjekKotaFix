                ...
                <!-- ========== Sidebar Area ========== -->
                   <div class="col-md-10">
                    <div class="single-blog-content mb-100">
                        <h2>Pengumuman</h2>
                         <?php foreach ($pengumuman->result() as $key): ?>
                        <article class="post-content">
                           
                            <div class="row">
                                <div class="col-md-5"> 
                                    <a class="img-thumbnail lightbox" href="#" data-plugin-options='{"type":"image"}'>
                                        <img class="img-responsive" src="<?php echo base_url()?>/upload/pengumuman/<?php echo $key->gambar ?>">
                                    </a>
                                </div>         
                                <div class="col-md-7">
                                    <div class="post-meta">
                                        
                                        <span><i class="fa fa-tag"></i> <b style="font-size: 30px;"><?php echo (strip_tags(substr($key->nama_pengumuman, 0,50))) ?></b></span><br/>
                                        <span><i class="fa fa-calendar-check-o"></i> <?php echo $key->tanggal_upload ?></span><br/>
                                        
                                        <span><i class="fa fa-user"></i> Penjelasan : <?php echo $key->deskripsi ?> </span>
                                    </div>
                                    <div >
